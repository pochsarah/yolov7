...
python -u train_loop.py --weights yolov7_training.pt --cfg cfg/training/yolov7.yaml --data data/al.yaml --hyp data/hyp.scratch.evolved.yaml --epochs 15 --img-size 416 --device 0 --single-cls --workers 4 --project 50_sum --name sum0 --save-txt --save-conf --task test --aggreg sum
