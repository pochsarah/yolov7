...
python -u train_loop.py --weights 50_sum/train/sum0_2_3_4_5_6_7_8_9_10_11_12/weights/best.pt --cfg cfg/training/yolov7.yaml --data data/al.yaml --hyp data/hyp.scratch.evolved.yaml --epochs 15 --img-size 416 --device 0 --single-cls --workers 4 --project 50_sum/train --name sum0_2_3_4_5_6_7_8_9_10_11_12_13 --save-txt --save-conf --task test --aggreg sum
